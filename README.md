...
* **[run-aspnetcore-spa](https://github.com/aspnetrun/run-aspnetcore-spa)** - intented to building **Single-Page Web Applications(SPA)** using only ASP.NET Core **without any frontend framework**. This comes with **[Blazor](https://dotnet.microsoft.com/apps/aspnet/web-apps/client)** framework with asp.net core 3.x.
